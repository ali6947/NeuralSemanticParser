...
local dataset_reader_name = "cbr_with_same_schema";

local train_data_path = "/mnt/infonas/data/alirehan/semantic_parsing/pickle_objs/bigbird_base/all_InstanceObj_spider_train_bigbird_base.pkl";
local validation_data_path = "/mnt/infonas/data/alirehan/semantic_parsing/pickle_objs/bigbird_base/all_InstanceObj_spider_val_bigbird_base.pkl";
local train_nbrs_path = "/mnt/infonas/data/awasthi/semantic_parsing/smbop/pickles/same_db_train_nbrs.pkl";
local val_nbrs_path = "/mnt/infonas/data/awasthi/semantic_parsing/smbop/pickles/same_db_val_nbrs.pkl";

{
  "dataset_reader": {
    ...
    "is_training": true,
    "neighbour_file": train_nbrs_path,
  },

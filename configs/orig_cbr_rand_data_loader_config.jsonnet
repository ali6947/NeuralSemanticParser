...
//local train_pkl= "pickle_objs/bigbird_base/spider_bigbird_gold_soft_ret_cases_train.pkl" ; # NOTE: change examples variable also
//local val_pkl= "pickle_objs/bigbird_base/spider_bigbird_gold_soft_ret_cases_val_from_train.pkl" ;

//local train_pkl= "pickle_objs/bigbird_base/spider_train_same_schema_high_cossim_cases.pkl" ; # NOTE: change examples variable also
//local val_pkl= "pickle_objs/bigbird_base/spider_val_same_schema_high_cossim_cases.pkl" ;

local train_pkl= "pickle_objs/bigbird_base/spider_train_same_schema_high_cossim_cases_10_cases.pkl" ; # NOTE: change examples variable also
local val_pkl= "pickle_objs/bigbird_base/spider_val_same_schema_high_cossim_cases_10_cases.pkl" ;
...

{
  ...
  "data_loader": {
    "type": "cbr_with_same_schema",
     "batch_sampler": {
        "type": "bucket",
        "sorting_keys": ["enc","depth"],
        "batch_size" : setting.batch_size,
    },
    //"max_instances_in_memory": 40 // NOTE: added new
  },

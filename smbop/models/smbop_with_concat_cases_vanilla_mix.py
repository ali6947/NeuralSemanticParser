...
class SmbopParser(Model):
    ...
    def forward(
        ...
        is_gold_span=None,
        inst_id=None,
        cases_enc=None, #NOTE: cases added new, cases is like 'enc' but having the data items added one after the other
        cases=None,
    ):
        ...
        (
            ...
            embedded_utterance,
            utterance_mask,
        ) = self._encode_utt_schema(enc, offsets, relation, lengths,cases_enc) #NOTE: cases added new

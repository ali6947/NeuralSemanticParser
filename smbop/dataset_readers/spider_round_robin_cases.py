...
class SmbopSpiderDatasetReader(DatasetReader):
    ...
    def text_to_instance(
        ...
        # utt_len = len(tokenized_utterance[1:]) #NOTE: changed because bigbird doesnt add any token at the end, use above line for grappa
        if self.value_pred:
    ...
    def extract_relation(self, desc):
        ...
        # print(question_concated)
        # print('*****')
        # print(col_concated)
        # print('*****')
        # print(table_concated)
        # print('*****')
    ...
    def hash_spans(self, tokenized_utterance):
        ...
        # utt_idx = [x.text_id for x in tokenized_utterance[1:]] #NOTE: changed because bigbird doesnt add any token at the end, use above line for grappa
        utt_len = len(utt_idx)
